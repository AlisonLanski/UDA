...
### Find sentiment scores for your data
...
You can show this using an aggregated dataframe/table or a plot.  
```{r}
...
Show how many times each emotion appears through the whole corpus.  Is it balanced? Do some emotions dominate?  (Show can be a dataframe/table or a graph)
```{r}
...
Select either polarity or emotions. Examine the relationship between sentiment and some other element of this dataset. 
