...
fruits <- c("strawberry", "blueberry", "raspberrrrry", "blackberrry", 
           "peaches", "pears", "kiwi", "papaya", "plums", "banana", 
           "honeycrisp", "winesap apples")
```
...
Can you find every word that has an a doubled letter (one letter, repeated)?
```{r}

```


Can you show me these fruits but with no vowels in them?
```{r}
...
```{r}
emails <- c("bob.ross@aol.com", "michelin.man@hotmail.com", "mario@yahoo.com", 
